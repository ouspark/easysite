...
object Service extends Space {
  ...
  override def render: Binding[BindingSeq[Node]] = {
    ...
    <div class="content">
      ...
      <p>
        To use this layout, you can just copy paste the HTML, along with the CSS in <a href="/css/layouts/side-menu.css" data:alt="Side Menu CSS">side-menu.css</a>, and the JavaScript in <a href="/js/ui.js">ui.js</a>. The JS file uses vanilla JavaScript to simply toggle an <code>active</code> class that makes the menu responsive.
      </p>
