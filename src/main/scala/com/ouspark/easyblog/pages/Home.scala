...
object Home extends Space {
  ...
  override def render: Binding[BindingSeq[Node]] = {
    <div class="posts">
      ...
      <section class="post">
        <header class="post-header">
          <img data:width="48" data:height="48" alt="Eric Ferraiuolo&#x27;s avatar" class="post-avatar" src="asset/img/common/ericf-avatar.png" />

          <h2 class="post-title"><a href="#post/test-post">Everything You Need to Know About Grunt</a></h2>
    ...
    <div class="posts">
      ...
      <section class="post">
        <header class="post-header">
          <img data:width="48" data:height="48" alt="Reid Burke&#x27;s avatar" class="post-avatar" src="asset/img/common/reid-avatar.png" />
      ...
      <section class="post">
        <header class="post-header">
          <img data:width="48" data:height="48" alt="Andrew Wooldridge&#x27;s avatar" class="post-avatar" src="asset/img/common/andrew-avatar.png" />
